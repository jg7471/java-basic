...
public class StrBuilderExample {
    ...
    public static void main(String[] args) {
        ...
        String str = "hello";
        System.out.println("str 주소값 " + str.hashCode());
        ...
        int idx = sb.indexOf("h"); //공백도 인식
        System.out.println("idx = " +idx);

        System.out.println(sb.length());

        System.out.println("sh의 주소값"+ sb.hashCode());
