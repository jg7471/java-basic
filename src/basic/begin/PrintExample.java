...
public class PrintExample {
    public static void main(String[] args) {
        ...
        System.out.print("프린트"); //이어서
        System.out.println("프린트엘엔"); // 이후 줄 바꿈
        System.out.print("프린트");
        System.out.println("프린트엘엔");
        System.out.print("프린트");
        System.out.println("프린트엘엔");
        ...
        //실수를 표현하는 서식문자 %f -> 기본 6자리까지 표현(반올림 지원)
        // %.[자리수를 지정하는 숫자] - _ 원하는 자리수까지 표현
        // %라는 문자 자체를 표현할 때는 %% 쓰면 됨
       double rate = 64.126;
        System.out.printf("합격률: %.2f%%f", rate); //f 빼먹음
