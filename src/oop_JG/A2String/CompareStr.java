...
public class CompareStr {
    public static void main(String[] args) {
        ...
        System.out.println(name == name2);//같지 않음
        ...
        System.out.println("password = "+ kim.pw);
        System.out.println("kim.pw = " + password);

        System.out.println("-----------------------------");

        System.out.println("==연산자의 결과" + (password == kim.pw)); //객체가 같은지?
        System.out.println("equals의 결과" + (password.equals(kim.pw))); //text 같은지?
